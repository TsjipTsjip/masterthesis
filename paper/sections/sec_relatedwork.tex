...
\comment{Victor: The entirety of this chapter rests on OSADL sources. Do I need to reference this in a special way, or simply every paragraph?}
...
\begin{itemize}
	...
	\comment{Victor: Consider explaining the interpretation of these licenses separately in an annex-ish section.}
\end{itemize}
