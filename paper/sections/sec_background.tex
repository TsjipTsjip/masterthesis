...
To start, we would like to provide an overview of standards in the industry which are relevant to this thesis, and which provide a leading effort in helping to handle complex software licensing interactions. These standards are listed in no particular order, and are generally accepted among the broader Open Source Software community.
...
Well-known examples of the strong copyleft license family are the GNU General Public License (GPL) and the GNU Affero General Public License (AGPL). The Copyleft Limited license family is represented by the well known GNU Lesser General Public License (LGPL)~\cite{scancode-licensedb}.
